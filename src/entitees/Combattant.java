...
public abstract class Combattant {
    ...
    /**
     * Permet de renvoyer un Combattant ciblé aléatoirement
     * @param c cible aléatoire choisie parmis les combattant
     */
    public void cibleAdverse(Equipe c) {
        cible =  c.choisirCombattantAleatoire();
    }
